...
public class WorkerRecolator extends SwingWorker<Void, Integer> implements Observer {
	private final JLabel lblProgreso;
	private final JProgressBar progressBar;
	private ModeloDescarga modeloDescargas;

	public WorkerRecolator(JLabel etiquetaProgreso, JProgressBar barraProgreso, ModeloDescarga modelo) {
